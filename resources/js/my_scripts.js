...
function changeTable(id){
	if(id == 1){
		document.getElementById("p_year").innerHTML += player[1,1]
		document.getElementById("p_major").innerHTML += player[1,5]
		document.getElementById("p_played").innerHTML += player[1,6]
	}
	if(id == 2){
		document.getElementById("p_year").innerHTML += player[2,1]
		document.getElementById("p_major").innerHTML += player[2,5]
		document.getElementById("p_played").innerHTML += player[2,6]
	}
	if(id == 3){
		document.getElementById("p_year").innerHTML += player[3,1]
		document.getElementById("p_major").innerHTML += player[3,5]
		document.getElementById("p_played").innerHTML += player[3,6]
	}
	if(id == 4){
		document.getElementById("p_year").innerHTML += player[4,1]
		document.getElementById("p_major").innerHTML += player[4,5]
		document.getElementById("p_played").innerHTML += player[4,6]
	}
}
